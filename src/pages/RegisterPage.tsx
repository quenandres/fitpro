...
export const RegisterPage = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // TODO: Reemplazar con supabase.auth.signUp({ email, password, options: { data: { full_name: name } } })
    ...
    <div className="auth-page">
      ...
      <div className="auth-container animate-fade-in">
        ...
        <div className="auth-social-group">
          <button type="button" className="fp-btn auth-social-btn" onClick={() => handleSocial('google')}>
          ...
          <button type="button" className="fp-btn auth-social-btn" onClick={() => handleSocial('github')}>
          ...
          <button type="button" className="fp-btn auth-social-btn" onClick={() => handleSocial('apple')}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
